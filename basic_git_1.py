...
class BasicGit:
    ...
    def _hash_object(self, data: str) -> str:
        ...
        encoded_data = data.encode("utf-8") # YOUR CODE HERE
        ...
        hash_object = hashlib.sha1(encoded_data) # YOUR CODE HERE
        hex_hash = hash_object.hexdigest() # YOUR CODE HERE
        if hex_hash is None:
            raise NotImplementedError(
    ...
    def add(self, path: str) -> None:
        ...
        try:
            with open(self.index_file, "w") as f: # YOUR CODE HERE
                f.write(abs_path) # YOUR CODE HERE
        except Exception as e:
            raise NotImplementedError(
    ...
    def commit(self, message: str) -> None:
        ...
        commit_string = str(commit_data) # YOUR CODE HERE - Get string representation of commit_data
        ...
        commit_sha = self._hash_object(commit_string) # YOUR CODE HERE - Hash the commit string
        ...
        try:
            with open(self.index_file, "w") as f: # YOUR CODE HERE - Open index file for writing
